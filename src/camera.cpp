...
namespace mt
{
	...
	{	//какая-то лютая математика по проецированию точки трёхмерного пространства на картинку
		// ������ ������ �� 90 ��������
		double X = p.x;
		double Y = -p.z;
		double Z = p.y;
		...
		// ������ ��������� �� �������
		if (z <= 0) // не проецируем точку, если она находится где-то за камерой
			return;

		// ������������� �������� (3D->2D)
		//здесь u и v - u' и v' из файла math1.png
		double u = x / z;
		double v = y / z;

		// ���������� ���������� ���������� ������
		//u и v - координаты проекции
	...
	void Camera::dX(double d) 
	{
		...
		m_position.y += 0; //y не поменяется, если он не равен -0.0, но нужно ли это здесь...
